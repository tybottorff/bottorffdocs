...
sample_names <- c(
  "GSM6668925_P1_T", "GSM6668926_P1_TN","GSM6668927_P2_T", "GSM6668928_P2_TN", "GSM6668929_P4_T", "GSM6668930_P4_TN", "GSM6668931_P5_T", "GSM6668932_P5_TN"
...
my.data_aggregate <- data.aggregation(samples = c("sample1","sample2","sample3","sample4","sample5","sample6","sample7","sample8"),
	condition.names = paired_values[1:8])

# very clunky for now

rm(sample1,sample2,sample3,sample4,sample5,sample6,sample7,sample8)
