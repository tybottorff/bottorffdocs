...
blood_t_cells_list <- list()  # Create a list to store the data for each sample

for (sample_name in sample_names) {
  sample_dir <- paste0("./raw_data/", sample_name, "/")
  blood_t_cells_list[[sample_name]] <- load10x(sample_dir)
}
...
# Aggregate iCellR objects from all samples

```{r}

my.data <- data.aggregation(samples = sample_names,
