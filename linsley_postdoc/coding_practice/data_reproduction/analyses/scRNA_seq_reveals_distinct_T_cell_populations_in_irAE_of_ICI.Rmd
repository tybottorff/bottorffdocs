...
# reduce applies merge cumulatively to elements of list
# [-1] excludes first element, init = seurat_objects[[1]] specifies first element
# probably a faster way to merge instead of iteratively, but not sure how to write yet without writing out all elements of seurat_objects in a list

seurat <- Reduce(function(x, y) merge(x, y), seurat_objects[-1], init = seurat_objects[[1]])
