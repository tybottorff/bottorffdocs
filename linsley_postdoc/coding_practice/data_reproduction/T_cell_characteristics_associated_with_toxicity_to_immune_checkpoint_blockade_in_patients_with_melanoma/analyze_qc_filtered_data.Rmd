...
# Split data into batches before integrating by finding anchors

```{r}

# split the dataset into a list of two seurat objects (a and b)
melanoma_T_cells_filtered.list <- SplitObject(melanoma_T_cells_filtered, split.by = "orig.ident")
