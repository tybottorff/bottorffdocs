...
stitchr_df <- combined_immunoseq_data %>%
  ...
  mutate(TCR_name = row_number(),
         ...
         TRB_5_prime_seq = NA,
         TRB_3_prime_seq = NA) %>%
  rename(TRBV = v_resolved,
         TRBD = d_resolved,
         TRBJ = j_resolved,
         TRB_CDR3 = cdr3_amino_acid) %>%
  select(TCR_name, TRAV, TRAD, TRAJ, TRA_CDR3, TRBV, TRBD, TRBJ, TRB_CDR3, TRAC, TRBC, TRA_leader, TRB_leader, Linker, Link_order, TRA_5_prime_seq, TRA_3_prime_seq, TRB_5_prime_seq, TRB_3_prime_seq)
