...
data <- data %>%
  ...
  filter(celltype %in% c("CD4 Proliferating", "CD8 Proliferating", "CD4 TEM", "CD8 TCM", "MAIT", "CD4 Trm")) %>%
...
cell_abundance_df <- feature_df %>%
  ...
  filter(predicted.celltype.l2 %in% c("CD4 Proliferating", "CD8 Naive", "CD4 TEM", "CD8 TCM", "MAIT", "CD4 Trm"),
         group != "no ICI")
...
# CD8 TCM: 0.01
# MAITs: 0.004
# CD4 Trm: 0.004662 (not adjusted yet)
...
cell_abundance_df_downsampled <- downsampled_df %>%
  ...
  ungroup() %>%
  # filter for just subtypes of interest
  filter(predicted.celltype.l2 %in% c("CD4 Proliferating", "CD4 TEM", "CD8 TCM", "MAIT", "CD8 Naive", "CD4 Trm"),
         group != "no ICI")
