...
DimPlot(tcr_and_rna, reduction = "umap", group.by = "group", shuffle = TRUE, seed = 455)
...
# DEG analysis between CD8 Trms with highest and lowest TRA pgen (log10) scores

```{r}

Idents(cd8_trms) <- "quantile"

#Idents(cd8_trms)

cd8_trms_degs <- FindMarkers(cd8_trms, ident.1 = "Bottom 10%", ident.2 = "Top 10%", verbose = FALSE)

cd8_trms_degs

```

# Pseudobulk to take into account that many cells come from same patient
