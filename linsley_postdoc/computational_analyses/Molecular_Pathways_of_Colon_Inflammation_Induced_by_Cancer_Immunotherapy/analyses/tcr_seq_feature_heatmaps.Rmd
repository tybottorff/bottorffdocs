...
combined_data <- combined_data %>%
  pivot_wider(id_cols = c(barcode, patient, group, predicted.celltype.l1, predicted.celltype.l2), names_from = "Chain", values_from = c("v_gene", "d_gene", "j_gene", "c_gene", "cdr3", "cdr3_nt", "pgen", "cdr3_length", "cdr3_hydrophobicity")) %>%
...
ggplot(prepped_data_downsampled %>% filter(predicted.celltype.l2 == "CD4 Proliferating" & Chain == "TRB"), aes(x = predicted.celltype.l2, y = log10(pgen), fill = group)) +
  geom_boxplot() +
  labs(x = "Cell type", y = "pgen (log10)") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 8))
