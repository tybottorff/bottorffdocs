---
title: "Distinct molecular and immune hallmarks of inflammatory arthritis induced by immune checkpoint inhibitor therapy"
output: pdf_document
---

 - data reproduction of https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9005525/
...
test1 <- read_tsv("../raw_data/GSE173303_subT_data_metadata.tsv")

test1

test2 <- read_tsv("../raw_data/GSE173303_whole_data_metadata.tsv")

test2

test3 <- read_tsv("../raw_data/GSE173303_barcodes.tsv")

test3

test4 <- read_tsv("../raw_data/GSE173303_features.tsv")
