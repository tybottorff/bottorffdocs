...
feature_df_doubled <- feature_df %>%
  ...
  select(cdr3, count_A_first_third) %>%
  arrange(-count_A_first_third)
...
ggplot(feature_df %>% filter(predicted.celltype.l1 == "CD8 T"), aes(x = Patient_ID, y = cdr3_length, fill = irAE)) +
  geom_boxplot() +
  facet_wrap(~ chain, scales = "free_y") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1, size = 8)) +
  labs(x = "Chain", fill = "irAE", y = "CD8 CDR3 length")
...
ggplot(feature_df %>% filter(predicted.celltype.l1 == "CD8 T" & predicted.celltype.l2 == "CD8 TEM"), aes(x = Patient_ID, y = cdr3_length, fill = irAE)) +
  geom_boxplot() +
  facet_wrap(~ chain, scales = "free_y") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1, size = 8)) +
...
merged_df <- feature_df %>%
  full_join(n_regions, by = "barcode") %>%
  mutate(N.REGION_TRB_length = nchar(N.REGION_TRB),
         N.REGION_TRA_length = nchar(N.REGION_TRA),
         N1.REGION_TRB_length = nchar(N1.REGION_TRB),
         N1.REGION_TRA_length = nchar(N1.REGION_TRA),
         N2.REGION_TRB_length = nchar(N2.REGION_TRB),
         N2.REGION_TRA_length = nchar(N2.REGION_TRA),
         N3.REGION_TRB_length = nchar(N3.REGION_TRB),
         N3.REGION_TRA_length = nchar(N3.REGION_TRA))

merged_df

# For TRA chain
ggplot(merged_df %>% filter(Chain == "TRA" & N.REGION_TRA_length != 0), 
       aes(x = cdr3_length, y = N.REGION_TRA_length)) +
  geom_jitter(size = 0.25, alpha = 0.25) +
  labs(x = "TRA CDR3 length",
       y = "TRA N region length") +
  geom_smooth(method = "lm", se = FALSE, color = "blue")

# For TRB chain
ggplot(merged_df %>% filter(Chain == "TRB" & N.REGION_TRB_length != 0), 
       aes(x = cdr3_length, y = N.REGION_TRB_length)) +
  geom_jitter(size = 0.25) +
  labs(x = "TRB CDR3 length",
       y = "TRB N1 region length") +
  geom_smooth(method = "lm", se = FALSE, color = "blue")

# For TRA chain
tra_slope <- lm(N.REGION_TRA_length ~ cdr3_length, data = merged_df %>% filter(Chain == "TRA" & N.REGION_TRA_length != 0))$coefficients[2]

# For TRB chain
trb_slope <- lm(N.REGION_TRB_length ~ cdr3_length, data = merged_df %>% filter(Chain == "TRB" & N.REGION_TRB_length != 0))$coefficients[2]
...
ggplot(expansion_df %>% filter(predicted.celltype.l1 == "CD8 T"), aes(x = Patient_ID, y = cdr3_length, fill = irAE)) +
  geom_boxplot() +
  facet_wrap(~ chain, scales = "free_y") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1, size = 8)) +
  labs(x = "Chain", fill = "irAE", y = "CD8 CDR3 length")
...
ggplot(expansion_df_unique %>% filter(predicted.celltype.l1 == "CD8 T"), aes(x = Patient_ID, y = cdr3_length, fill = irAE)) +
  geom_boxplot() +
  facet_wrap(~ chain, scales = "free_y") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1, size = 8)) +
  labs(x = "Chain", fill = "irAE", y = "CD8 CDR3 length")
...
ggplot(plot_df %>% filter(predicted.celltype.l1 == "CD8 T"), aes(x = Patient_ID, y = log10(pgen), fill = irAE)) +
  geom_boxplot() +
  facet_wrap(~ chain, scales = "free_y") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1, size = 8)) +
  labs(x = "Chain", fill = "irAE", y = "CD8 log10(pgen)")
