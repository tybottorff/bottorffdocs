...
# Create df for just solid conclusions for CD8 TEM CDR3B length
...
unique_cd8_tems <- downsampled_df %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         Chain == "TRB") %>%
  mutate(label = "All",
...
public_cd8_tems <- downsampled_df %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         publicness == "public",
         Chain == "TRB") %>%
...
unique_public_cd8_tems <- downsampled_df %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         publicness == "public",
         Chain == "TRB") %>%
...
private_cd8_tems <- downsampled_df %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         publicness == "private",
         Chain == "TRB") %>%
...
unique_private_cd8_tems <- downsampled_df %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         publicness == "private",
         Chain == "TRB") %>%
...
unique_expanded_cd8_tems <- expansion_df %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         Chain == "TRB") %>%
  filter(expansion_degree %in% c("Medium", "Large", "Hyperexpanded")) %>%
...
p_values <- c(0.0001699, 0.1711, 4.004e-05, 0.0001699)
...
unique_cd8_tems <- igor_combined %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         Chain == "TRB") %>%
  mutate(label = "Unique CD8 TEMs") %>%
  group_by(cdr3, Patient_ID, chain) %>%
  dplyr::slice(1)

public_cd8_tems <- igor_combined %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         publicness == "public",
         Chain == "TRB") %>%
  mutate(label = "Public CD8 TEMs")

private_cd8_tems <- igor_combined %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         publicness == "private",
         Chain == "TRB") %>%
  mutate(label = "Private CD8 TEMs")

unique_public_cd8_tems <- igor_combined %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         publicness == "public",
         Chain == "TRB") %>%
  mutate(label = "Unique public CD8 TEMs") %>%
  group_by(cdr3, Patient_ID, chain) %>%
  dplyr::slice(1)
...
unique_expanded_cd8_tems <- igor_combined %>%
  filter(predicted.celltype.l1 == "CD8 T",
         predicted.celltype.l2 == "CD8 TEM",
         Chain == "TRB") %>%
  filter(expansion_degree %in% c("Medium", "Large", "Hyperexpanded")) %>%
  mutate(label = "Unique highly\nexpanded\nCD8 TEMs") %>%
  group_by(cdr3, Patient_ID, chain) %>%
  dplyr::slice(1)
...
ggplot(joined_df, aes(x = label, y = log10(pgen), fill = irAE)) +
  geom_boxplot() +
  labs(x = "", fill = "irAE", y = "TRB pgen\n(log10)") +
  scale_x_discrete(limits = c("All CD8 TEMs", "Public CD8 TEMs", "Private CD8 TEMs", "Highly expanded\nCD8 TEMs")) +
...
p_values <- c(1.499e-07, 0.1412, 8.354e-09, 3.987e-09)
