...
split = data.frame(x = c(rep("", which_row_highlight - 1), "*", rep("", nrow(mat) - which_row_highlight)))
...
split = data.frame(x = c(rep("", which_row_highlight - 2), "*", "*", rep("", nrow(mat_downsampled) - which_row_highlight)))
