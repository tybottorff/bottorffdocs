...
ggplot(results_df %>% filter(predicted.celltype.l1 == "CD8 T" & predicted.celltype.l2 %in% c("CD8 TEM")), aes(x = top_n_clonotypes, y = p_val_pgen)) +
  geom_point(size = 0.01) +
  geom_hline(yintercept = 0.05, linetype = "dashed", color = "red") +
  facet_wrap(~Chain + predicted.celltype.l2, ncol = 3) +
  labs(x = "Top n clonotypes (normalized\nfor sequencing depth)", y = "Wilcox p val for yes\nvs. no irAE pgen scores") +
