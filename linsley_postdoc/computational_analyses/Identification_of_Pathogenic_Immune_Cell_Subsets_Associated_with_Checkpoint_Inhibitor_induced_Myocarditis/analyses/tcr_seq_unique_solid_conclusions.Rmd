...
ha = HeatmapAnnotation(
  cell_type = factor(heatmap_data$predicted.celltype.l1, levels = c("CD4 T", "CD8 T", "other T")),
  cell_sub_type = factor(heatmap_data$predicted.celltype.l2, levels = c("CD4 T CTL", "CD4 Naive", "CD4 TCM", "CD4 TEM", "CD4 Proliferating", "Treg", "CD8 Naive", "CD8 TCM", "CD8 TEM", "CD8 Proliferating", "MAIT", "dnT")),
  chain = factor(heatmap_data$Chain, levels = c("TRA", "TRB")),
  feature = factor(heatmap_data$p_val_category, levels = c("cdr3_length", "cdr3_hydrophobicity", "pgen")),
  col = list(cell_type = c("CD4 T" = "red", "CD8 T" = "green", "other T" = "blue"),
               cell_sub_type = c("CD4 T CTL" = "#FF6347",
                                 "CD4 Naive" = "#FF0000",
                                 "CD4 TCM" = "#FF4500",
                                 "CD4 TEM" = "#DC143C",
                                 "CD4 Proliferating" = "#FF69B4",
                                 "Treg" = "#B22222",
                                 "CD8 Naive" = "#00BFFF",
                                 "CD8 TCM" = "#1E90FF",
                                 "CD8 TEM" = "#4169E1",
                                 "CD8 Proliferating" = "#00008B",
                                 "MAIT" = "#008000",
                                 "dnT" = "#00FF00"),
               chain = c("TRA" = "red", "TRB" = "green"),
               feature = c("cdr3_length" = "red", "cdr3_hydrophobicity" = "green", "pgen" = "blue")
    )
)
