...
ggplot(tcr_igor_pivoted_with_irAE, aes(x = Chain, y = neg_log_pgen, color = severe_irAE)) +
  geom_violin() +
  labs(x = "Chain", y = "-log10(pgen, ~germline-ness)")

# IGoR pgen notes: Junction sequences with higher (less negative) pgen values have a higher probability of generation by V(D)J recombination. Conversely, sequences with lower (more negative) pgen values have a lower probability of generation. So higher -log10(pgen value) means higher probability of generation (more germline-like)
