...
# retry just for specific chr? not sure if IRanges is correct for hg38 though
...
```
 ...
 - if not paired reads, then they won't have same size i.e. first and second(atacReads) different sizes...? so check insert size stuffs for both?
 
 Warning:   57808 alignments with ambiguous pairing were dumped.
