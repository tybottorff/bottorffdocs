...
```{r}
chr1_list[[1]]@elementMetadata$libid
```
...
# Plot signal over TSSs (expect nucleosome free regions at TSSs of active genes, nucleosome signal enriched next to TSS) for 1 .bam file

 - error: "Error in DataFrame(..., check.names = FALSE) :  different row counts implied by arguments"
...
# Nucleosome free
nucFree <- regionPlot(bamFile = "/mnt/bioinformatics/pipeline/Illumina/220802_VH00126_203_AAAMVKNHV/Project_P452-3Processed_globus_220807/shiftedAlignments/lib82438_AAAMVKNHV_star_alignments_shifted_sorted.bam", testRanges = TSSs, style = "point", format = "bam", paired = TRUE, minFragmentLength = 0, maxFragmentLength = 100, forceFragment = 50)

# Mononucleosome
monoNuc <- regionPlot(bamFile = "/mnt/bioinformatics/pipeline/Illumina/220802_VH00126_203_AAAMVKNHV/Project_P452-3Processed_globus_220807/shiftedAlignments/lib82438_AAAMVKNHV_star_alignments_shifted_sorted.bam", testRanges = TSSs, style = "point", format = "bam", paired = TRUE, minFragmentLength = 180, maxFragmentLength = 240, forceFragment = 80)

# Dinucleosome
diNuc <- regionPlot(bamFile = "/mnt/bioinformatics/pipeline/Illumina/220802_VH00126_203_AAAMVKNHV/Project_P452-3Processed_globus_220807/shiftedAlignments/lib82438_AAAMVKNHV_star_alignments_shifted_sorted.bam", testRanges = TSSs, style = "point", format = "bam", paired = TRUE, minFragmentLength = 315, maxFragmentLength = 437, forceFragment = 160)
