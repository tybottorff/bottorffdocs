...
cell_type_abundances$group <- factor(cell_type_abundances$group, levels = c("ICI no colitis", "ICI colitis"))

ggplot(cell_type_abundances, aes(x = predicted.celltype.l2, y = log10(normalized_count), fill = group)) +
  geom_boxplot() +
...
test_data <- cell_type_abundances %>%
