...
# combined irAE: interaction effects (SCM of Tconv Tcells, CD56bright of NK cells, EM of CD8s)

# if looking at pneumonitis instead of combined: no results

# for skin, some treatment effects and 1 interaction (group-visit 3 for CD56bright of NK cells, padj = 0.048)
...
# for rheumatoid, interaction (group-visit3) effects for DN of Tcells (padj = 0.04) and CRTH2+ of NN Tconv Tcells (padj = 0.015)
