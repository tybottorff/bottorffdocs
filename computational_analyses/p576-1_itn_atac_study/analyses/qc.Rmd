...
dataDir <- function(fname) {
  return (file.path(baseDir,'../raw_data', fname))
}
...
flowcellDirectories = c("/mnt/bioinformatics/pipeline/...")
...
# run this with deeptools installed in the current python environment
cores=48
