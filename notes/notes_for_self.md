# High priority P576/AbATE/TN10 TODOs:
 - **paper writing: what do we need new experiments/analyses (on current data) wise? what can we combine P576 with? draft main figs (what we have and also what we could have...), what does Josh have that we could add in? could consider just going as is for a brief communications style journal paper... what's the role of location... all PBMCs but literature describes term Tex as tissue-resident/in peripheral tissue and (some) prog Tex in lymphoid tissue (not as worried here as multiple prog Tex pops some lymphoid some peripheral apparently...), maybe DP CD57+ in blood here heading to peripheral tissue or moving back out idk... high cytotoxicity marker expression could also just mean antigen experience apparently...**
 - **Homer:  literature relation for TFs here? look for sub Tex-specific TFs!! https://ars.els-cdn.com/content/image/1-s2.0-S1074761323004879-gr1_lrg.jpg, panel C but B/D also look interesting... Runx1-2 apparently effector-related TFs, higher in DP CD127- vs. earlier cells? NFAT (RHD) and BATF (bZIP) involved in Tex, up in DP? Teff or Tmem-related TFs (i.e., Tbx21, Id3, and Stat5a). does Tcf1 (Tcf7) pop up in DP CD127- vs. DP CD127+? expect higher in prog Tex... look at VP for DP CD127+ vs. DP CD127- background all peaks expect to see Stat5 pop up! does it fit with paper showing Stat5 drives int Tex fate? careful with Stat5a vs. b... try again to consolidate something consistent with story from homer results, could help flesh out paper/story! look at DP CD127+ vs. other DPs separately**
